import {
  ...
  /* Test execited as it should 5 test total: 4 passed and 1 failed.
  1. An unsaved changes doesn't persist was handled correctly
  2. A canceled changes was handled correctly.
  3. Saved changes was NOT handled correctly due, further changes and testing required.
  4. Error message for invalid input was handled correctly 
  5. Last test for error message for clear input and fixing it and make sure error message is gone as well was handled correclty
  
  So due to that, that saved checnges was not there, it requires manual testing around.
  */